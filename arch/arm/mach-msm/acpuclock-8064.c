...
// We aren't using L2(1), comment it out to avoid having to change
// all the tables when I added a new low clock value
//	[1]  = { {  432000, HFPLL, 2, 0x20 }, 1050000, 1050000, 2 },
	...
	[16] = { { 1350000, HFPLL, 1, 0x32 }, 1175000, 1175000, 6 },
	{ }
};
...
static struct acpu_level tbl_slow[] __initdata = {
	...
	{ 1, {  1917000, HFPLL, 1, 0x47 }, L2(16), 1400000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_nom[] __initdata = {
	...
	{ 1, {  1836000, HFPLL, 1, 0x44 }, L2(15), 1262500 },
	{ 1, {  1890000, HFPLL, 1, 0x46 }, L2(16), 1275000 },
	{ 1, {  1917000, HFPLL, 1, 0x47 }, L2(16), 1375000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_fast[] __initdata = {
	...
	{ 1, {  1917000, HFPLL, 1, 0x47 }, L2(16), 1350000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_faster[] __initdata = {
	...
	{ 1, {  1917000, HFPLL, 1, 0x47 }, L2(16), 1275000 },
	{ 0, { 0 } }
};
